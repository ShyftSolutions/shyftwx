import { Box, Collapse, List, ListItem, ListItemIcon, ListItemText, Typography, makeStyles } from '@material-ui/core';
...
import { ShyftContext } from '../root/ShyftWx';
...
export const ProductMenu: React.FC<ProductMenuProps> = ({ options = emptyMenu, action }) => {
    const { runs } = React.useContext(ShyftContext);
    console.log(runs);
